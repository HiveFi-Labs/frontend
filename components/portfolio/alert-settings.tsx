          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  defaultChecked={notificationPreferences.email.enabled}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  defaultChecked={notificationPreferences.email.dailyDigest}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  defaultChecked={notificationPreferences.push.quietHours}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  defaultChecked={notificationPreferences.sms.criticalOnly}
                />
              </div>
            </div>
          </div>
        ...
        {['performance', 'risk', 'strategy', 'market'].map((category) => (
          <TabsContent key={category} value={category} className="mt-0">
            <div className="space-y-4">
              ...
              {alerts.filter((alert) => alert.type === category).length ===
                0 && (
                <div className="flex flex-col items-center justify-center py-12 bg-zinc-900/30 rounded-lg border border-zinc-800/50">
                  ...
                  >
                    <Plus className="w-4 h-4 mr-2" />
                    Create{' '}
                    {category.charAt(0).toUpperCase() + category.slice(1)} Alert
                  </Button>
                </div>
              )}
            </div>
          ...
          <div className="bg-zinc-900 rounded-xl w-full max-w-md">
            <div className="p-4 border-b border-zinc-800">
              ...
              <p className="text-sm text-zinc-400">
                Configure a new alert for your portfolio
              </p>
            </div>
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue="portfolio_up">
                  ...
                  <SelectContent className="bg-zinc-900 border-zinc-800">
                    <SelectItem value="portfolio_up">
                      Portfolio up by X%
                    </SelectItem>
                    <SelectItem value="portfolio_down">
                      Portfolio down by X%
                    </SelectItem>
                    <SelectItem value="strategy_up">
                      Strategy up by X%
                    </SelectItem>
                    <SelectItem value="strategy_down">
                      Strategy down by X%
                    </SelectItem>
