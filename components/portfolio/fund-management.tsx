...
import { ArrowUpRight, ArrowDownLeft, Calendar, RefreshCw, AlertTriangle, ArrowRight } from "lucide-react"
...
import type { Transaction, Rebalance, FundSummary, ProfitHandlingSettings } from "@/types/portfolio"
...
export default function FundManagement() {
  ...
  const [profitHandlingSettings, setProfitHandlingSettings] = useState<ProfitHandlingSettings | null>(null)
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setIsLoading(true)
        const [transactionsData, rebalanceData, fundData, profitData] = await Promise.all([
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch defaultChecked={profitHandlingSettings.autoReinvest} />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select defaultValue={profitHandlingSettings.withdrawalMethod}>
                      <SelectTrigger className="w-full bg-zinc-900/50 border-zinc-700 text-zinc-300">
              ...
              <div className="mt-6 p-4 bg-zinc-800/30 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-zinc-400">
                    Changing rebalancing settings may trigger taxable events. Please consult with a tax professional
                    before making significant changes to your portfolio management strategy.
                  </p>
                </div>
              </div>
