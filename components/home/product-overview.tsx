...
export default function ProductOverview() {
  const {
    ...
    isLoading,
    error,
  } = useDataFetch<ProductFeature[]>(portfolioData.getProductFeatures)
        ...
        <Card key={feature.title} className="glass-card overflow-hidden group">
          ...
          <CardContent>
            <p className="text-zinc-300">
              Create custom trading strategies using technical indicators, price
              action, and volume metrics through an intuitive drag-and-drop
