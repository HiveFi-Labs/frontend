...
export default function MarketplaceStrategies({
  strategies,
  onStrategySelect,
}: MarketplaceStrategiesProps) {
  ...
  const getFilteredStrategies = () => {
    if (activeCategory === 'popular') {
      ...
      return [...strategies].sort((a, b) => {
        const aReturn = Number.parseFloat(
          a.performance.return.replace('%', '').replace('+', ''),
        )
        const bReturn = Number.parseFloat(
          b.performance.return.replace('%', '').replace('+', ''),
        )
