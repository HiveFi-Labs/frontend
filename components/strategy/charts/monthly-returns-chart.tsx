    ...
    <div className="bg-zinc-800/50 rounded-lg p-4">
      ...
      <div className="h-[200px] relative">
        <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          {/* Zero line */}
          <line x1="10" y1="50" x2="90" y2="50" stroke="#6b7280" strokeWidth="0.2" strokeDasharray="0.5" />
        ...
        <div className="absolute top-0 left-0 h-full flex flex-col justify-between py-2">
          <div
            ...
            style={{ position: "absolute", left: "8px", top: "30%", transform: "translateY(-50%)" }}
          >
            +5%
          </div>
          <div
          ...
          <div
            className="text-xs text-zinc-500"
            style={{ position: "absolute", left: "8px", top: "70%", transform: "translateY(-50%)" }}
          >
            -5%
          </div>
        </div>
