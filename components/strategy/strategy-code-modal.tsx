      ...
      <div className="bg-zinc-900 rounded-xl w-full max-w-5xl max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-4 border-b border-zinc-800">
          <div className="flex items-center gap-2">
            <h3 className="text-xl font-semibold text-white">Strategy Code Editor</h3>
            <Tabs value={activeTab} onValueChange={setActiveTab} className="ml-4">
              <TabsList className="bg-zinc-800">
                <TabsTrigger value="strategy" className="data-[state=active]:bg-zinc-700">
                  TrendFollowingStrategy.js
                </TabsTrigger>
                <TabsTrigger value="indicators" className="data-[state=active]:bg-zinc-700">
                  indicators.js
                </TabsTrigger>
              </TabsList>
            </Tabs>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="bg-zinc-900 border-zinc-800">
                ...
                <DropdownMenuItem
                  ...
                  onClick={() => handleCopy(activeTab === "strategy" ? strategyCode : indicatorsCode)}
                >
        ...
        <div className="p-4 border-t border-zinc-800 flex justify-between">
          <div>{hasChanges && <span className="text-yellow-400 text-sm">You have unsaved changes</span>}</div>
          <div className="flex gap-2">
            <Button variant="outline" className="border-zinc-700 text-zinc-300" onClick={onClose}>
              Cancel
            </Button>
            <Button className="gradient-button" onClick={handleSave} disabled={!hasChanges}>
