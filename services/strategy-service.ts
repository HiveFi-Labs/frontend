...
class StrategyService {
  ...
  async getTradeHistory(): Promise<TradeHistoryItem[]> {
    return apiClient.get<TradeHistoryItem[]>(
      '/strategy-development/trade-history',
    )
  }
  ...
  async getOptimizationResults(): Promise<OptimizationResult[]> {
    return apiClient.get<OptimizationResult[]>(
      '/strategy-development/optimization-results',
    )
  }
  ...
  async getMonthlyReturns(): Promise<MonthlyReturn[]> {
    return apiClient.get<MonthlyReturn[]>(
      '/strategy-development/monthly-returns',
    )
  }
  ...
  async getEquityCurveData(): Promise<EquityCurvePoint[]> {
    return apiClient.get<EquityCurvePoint[]>(
      '/strategy-development/equity-curve',
    )
  }
  ...
  async getStrategySettings(): Promise<StrategySettings> {
    return apiClient.get<StrategySettings>(
      '/strategy-development/strategy-settings',
    )
  }
}
