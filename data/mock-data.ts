...
export const featuresData = [
  {
    ...
    description:
      'Create complex trading strategies with an intuitive drag-and-drop interface. No coding required.',
    icon: 'Code2',
  },
  {
    title: 'Advanced Backtesting',
    description:
      'Test your strategies against historical data with comprehensive performance metrics and analysis.',
    icon: 'BarChart3',
  },
  {
    title: 'AI-Powered Strategy Creation',
    description:
      'Leverage artificial intelligence to create, optimize, and improve your trading strategies.',
    icon: 'MessageSquare',
  },
  {
    title: 'Risk Management',
    description:
      'Set precise risk parameters to protect capital and ensure strategies align with risk tolerance.',
    icon: 'Shield',
  },
  {
  ...
  },
  {
    ...
    description:
      'Discover and invest in verified strategies or monetize your own trading expertise.',
    icon: 'LineChart',
  },
]
...
export const problemSolutionsData = [
  ...
  },
  {
    ...
    description:
      'Traditional copy trading requires extreme trust as trader actions cannot be predicted.',
